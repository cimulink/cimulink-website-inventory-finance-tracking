...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <section id="why-choose-us" className="relative py-20 bg-gradient-to-br from-green-50/30 via-background to-blue-50/30 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              <Card className="group relative p-8 bg-gradient-to-br from-white to-green-50/50 border-green-200/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <CardHeader className="text-center pb-4">
                    <CardTitle className="text-xl font-bold text-green-800 group-hover:text-green-900 transition-colors">Smart Forecasting & Analytics</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-gray-600 group-hover:text-gray-700 transition-colors leading-relaxed">
                      Get predictive insights on when to reorder, which books are trending, and demographic analysis to optimize your inventory and marketing strategies.
                    </p>
                  </CardContent>
                </div>
              </Card>
              ...
              <Card className="group relative p-8 bg-gradient-to-br from-white to-blue-50/50 border-blue-200/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <CardHeader className="text-center pb-4">
                    <CardTitle className="text-xl font-bold text-blue-800 group-hover:text-blue-900 transition-colors">Seamless Platform Integration</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-gray-600 group-hover:text-gray-700 transition-colors leading-relaxed">
                      Automatically sync with Flipkart, Amazon, and other major platforms for unified order management, inventory tracking, and sales analytics.
                    </p>
                  </CardContent>
                </div>
              </Card>
              ...
              <Card className="group relative p-8 bg-gradient-to-br from-white to-purple-50/50 border-purple-200/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <CardHeader className="text-center pb-4">
                    <CardTitle className="text-xl font-bold text-purple-800 group-hover:text-purple-900 transition-colors">Advanced Reporting Suite</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-gray-600 group-hover:text-gray-700 transition-colors leading-relaxed">
                      Comprehensive reports on sales trends, inventory performance, and financial insights to help you make data-driven business decisions.
                    </p>
                  </CardContent>
                </div>
              </Card>
            ...
            <div className="bg-gradient-to-r from-primary/10 via-blue-50/50 to-green-50/30 rounded-3xl p-10 border border-primary/20 hover:shadow-2xl transition-all duration-500 group">
              <div className="flex items-center justify-center gap-4 mb-6">
                <div className="p-3 bg-gradient-to-r from-primary to-blue-600 rounded-full group-hover:scale-110 transition-transform duration-300">
                  <BookOpen className="h-8 w-8 text-white" />
                </div>
                <h3 className="text-2xl md:text-3xl font-bold font-playfair">Ready to Transform Your Operations?</h3>
              </div>
              <p className="text-lg text-gray-700 mb-8 text-center max-w-3xl mx-auto leading-relaxed">
                Join forward-thinking publishers and educational institutions who are ready to streamline their backoffice operations with BookFlow.
              </p>
              <div className="text-center">
                <Button 
                  asChild
                  size="lg" 
                  className="text-lg px-12 py-6 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 transition-all duration-300 hover:scale-105 hover:shadow-xl"
                >
                  <a 
                    href="https://calendly.com/ajay_k_gupta/30min" 
                    target="_blank" 
      ...
      <section className="bg-primary text-primary-foreground py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <h2 className="text-3xl md:text-4xl font-bold">Built for Books, Not Generic Boxes</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
              <div className="flex items-start gap-4">
                <BookOpen className="h-6 w-6 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-lg mb-2">Industry-Specific Functionality</h3>
                  <p className="opacity-90">Tools like Batch Management and Book Set Kitting that generic systems lack.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <Users className="h-6 w-6 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-lg mb-2">Expert Implementation</h3>
                  <p className="opacity-90">Work directly with a solutions architect who understands the publishing industry.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <Zap className="h-6 w-6 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-lg mb-2">A Single Source of Truth</h3>
                  <p className="opacity-90">Unify your inventory, orders, and payments into one seamless platform.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <TrendingUp className="h-6 w-6 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-lg mb-2">AI-Powered Forecasting</h3>
                  <p className="opacity-90">Use predictive analytics to make smarter purchasing and sales decisions.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="opacity-90">Connect with your existing accounting, e-commerce, and shipping platforms.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <Settings className="h-6 w-6 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-lg mb-2">Custom Implementation</h3>
                  <p className="opacity-90">We adapt BookFlow to work with your existing workflows and tools, ensuring seamless integration.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="features" className="relative py-20 bg-gradient-to-br from-slate-50/50 via-background to-blue-50/50 overflow-hidden">
        <div className="absolute inset-0 bg-grid-black/5 bg-[size:50px_50px]" />
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-transparent via-white/80 to-transparent" />
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center space-y-6 mb-16">
              <h2 className="text-3xl md:text-4xl font-bold font-playfair">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto font-poppins">
                BookFlow provides a comprehensive suite of tools designed specifically for publishers and educational institutions.
              </p>
      ...
      <section className="relative py-20 bg-gradient-to-br from-green-50/30 via-background to-blue-50/30">
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/60 to-transparent" />
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <h2 className="text-3xl md:text-4xl font-bold animate-in fade-in duration-700">Your Streamlined Backoffice is 3 Steps Away</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <div className="space-y-4 animate-in slide-in-from-bottom duration-700 delay-200 group hover:scale-105 transition-all">
                <div className="bg-gradient-to-r from-primary to-blue-600 text-primary-foreground w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mx-auto shadow-lg group-hover:shadow-xl transition-all">
                  1
                </div>
                <h3 className="text-xl font-semibold">Discovery & Strategy Call</h3>
                <p className="text-gray-600">
                  We map out your current backoffice workflows to understand your unique challenges and goals.
                </p>
              </div>
              <div className="space-y-4 animate-in slide-in-from-bottom duration-700 delay-400 group hover:scale-105 transition-all">
                <div className="bg-gradient-to-r from-primary to-blue-600 text-primary-foreground w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mx-auto shadow-lg group-hover:shadow-xl transition-all">
                  2
                </div>
              ...
              <div className="space-y-4 animate-in slide-in-from-bottom duration-700 delay-600 group hover:scale-105 transition-all">
                <div className="bg-gradient-to-r from-primary to-blue-600 text-primary-foreground w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mx-auto shadow-lg group-hover:shadow-xl transition-all">
                  3
                </div>
                <h3 className="text-xl font-semibold">Go Live & Grow</h3>
                <p className="text-gray-600">
